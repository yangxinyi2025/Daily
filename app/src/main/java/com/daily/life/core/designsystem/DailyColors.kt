...
val SkyPrimary = Color(0xFF7B6CF6)
val SkySecondary = Color(0xFF76B8C7)
val SkySuccess = Color(0xFF61B486)
val SkyAccent = Color(0xFF7B6CF6)
val SkyWarm = Color(0xFFF57FA3)
